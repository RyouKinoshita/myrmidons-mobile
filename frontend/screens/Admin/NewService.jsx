...
import { createService } from "../../redux/actions/otherAction";
...
const NewService = ({ navigation, route }) => {
  ...
  const [category, setCategory] = useState("Choose service category");
  const [categoryID, setCategoryID] = useState(undefined);
  const [categories, setCategories] = useState([]);

  useSetCategories(setCategories, isFocused);

  const disableBtnCondition = !name || !description || !price || !image;
